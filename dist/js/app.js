(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        if (stepSliderValueElement) priceSlider.noUiSlider.on("update", (function(values, handle) {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".old-currency-slider")) new core(".old-currency-slider", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 10,
        ...
        const enableSwiper = function() {
            if (document.querySelector(".benefit__slider")) mySwiper = new core(".benefit__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        function headerScroll() {
            ...
            document.addEventListener("windowScroll", (function(e) {
                ...
                if (scrollTop >= startPoint) {
                    ...
                    !toTop.classList.contains("scroll") ? toTop.classList.add("scroll") : null;
                    if (headerShow) {
                    ...
                    toTop.classList.contains("scroll") ? toTop.classList.remove("scroll") : null;
        ...
        (function langSwitcher() {
            ...
            if (langSwitcher) langSwitcherOpener.addEventListener("click", (function(e) {
                langSwitcher.classList.contains("active") ? langSwitcher.classList.remove("active") : langSwitcher.classList.add("active");
            }));
        })();
        (function langSwitcher() {
